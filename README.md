...
[Module 18 Homework files](Instructions/Starter_Code/pychain.py)
...
![alt=""](images/11_Record_Class.png)  
...
![alt=""](images/41_Run_Streamlit.png)  

2. In the terminal, run the Streamlit application by using `streamlit run pychain.py`.

![alt=""](images/42_Test_Start.png)  

3. Enter values for the sender, receiver, and amount, and then click the Add Block button. Do this several times to store several blocks in the ledger.

![alt=""](images/43_Test_Transactions.png)  
...
![alt=""](images/44_Test_Transactions_2.png)  
...
![alt=""](images/45_Test_ValidateChain.png)  
